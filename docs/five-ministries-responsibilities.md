...
- ✅ 代码必须能编译通过（`tsc`零错误）
- ✅ 没有`any`类型或`unknown`类型
- ✅ 没有`console.log`或调试代码
- ✅ 遵循文件中现有的代码风格（缩进、命名、导入顺序）
- ✅ 所有导入都能正确解析
- ✅ 没有未使用的导入或变量
- ✅ 函数必须有JSDoc注释（至少包含参数和返回值）
- ✅ 必须处理所有可能的错误路径
